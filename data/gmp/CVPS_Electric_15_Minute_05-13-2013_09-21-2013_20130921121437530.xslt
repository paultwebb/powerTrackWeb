...
<body>
<span style="font-family:Century Gothic; font-size:larger;">
...
<tr>
<td>
<span style="font-family:Century Gothic; font-size:larger; font-weight:bold; ">
<xsl:text>Energy Usage Information</xsl:text>
</span>
</td>
</tr>
<tr>
...
<td>
<span style="font-family:Century Gothic; font-size:larger; font-weight:bold; ">
<xsl:text>Summary of Electric Power Usage Information*</xsl:text>
</span>
</td>
</tr>
<tr>
...
<td>
<span style="font-family:Century Gothic; font-size:larger; font-weight:bold; ">
<xsl:text>Hourly Electricity Usage</xsl:text>
</span>
<br/>
<br/>
...
<xsl:for-each select="espi:ElectricPowerUsageSummary">
<span>
<xsl:value-of select="format-number((espi:statusTimeStamp - espi:billingPeriod/espi:start) div(86400),&apos;##&apos;)"/>
</span>
<span>
...
<tr>
<td>
<table style="font-family:Century Gothic; font-style:normal; " border="1">
<thead style="font-family:Century Gothic; font-style:normal; ">
...
<td align="right">
<xsl:for-each select="espi:value">
<xsl:apply-templates/>
</xsl:for-each>
</td>
...
<xsl:variable name="strTemp">
<xsl:call-template name="convert-unix-to-date-time">
<xsl:with-param name="dtTmp" select="$vStart + $vDuration"/>
</xsl:call-template>
</xsl:variable>
<xsl:value-of select="concat(substring-before($strTemp , 'T'), ' ', substring-after( $strTemp , 'T'))"/>
</xsl:template>
